...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-base-200 to-base-300 px-4">
      ...
      <div className="w-full max-w-sm sm:max-w-md lg:max-w-lg bg-base-100 shadow-2xl rounded-2xl p-6 sm:p-8 border border-base-300 transition-all duration-300">
        ...
        <form onSubmit={handleSubmit(handleLogin)} className="space-y-4">
          ...
          {/* Forgot */}
          <div className="text-right">
            <a className="text-xs sm:text-sm text-primary hover:underline cursor-pointer">
              Forgot password?
            </a>
          </div>

          {/* Button */}
          <button className="btn btn-primary w-full text-white hover:scale-[1.02] transition">
            Login
          </button>
