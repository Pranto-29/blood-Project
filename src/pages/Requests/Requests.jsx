...
//     try {
//       if (currentUser?.role === "admin") {
//         await axiosSecure.delete(`/add-request/${id}`);
...
//             <div>
//              <p className=" font-bold text-xl text-pink-400">Name: {req.recipient_name}</p>
//              <p className="text-blue-600">Request Email :{req.requester_email}</p>
//              <p className="text-green-600"> Hospital Name :{req.hospital_name}</p>
//              <p className="text-yellow-600">Blood Group: {req.blood_group}</p>
//              <p className="text-purple-600">District Name: {req.recipient_district}</p>
//              <p className="text-red-600">Upazila Name: {req.recipient_upazila}</p>
